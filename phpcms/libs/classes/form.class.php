...
class form {
	...
	public static function date($name, $value = '', $isdatetime = 0, $loadjs = 0, $showweek = 'true', $timesystem = 1) {
		...
		if($loadjs || !defined('CALENDAR_INIT')) {
			...
			$str .= '<link rel="stylesheet" type="text/static" href="'.JS_PATH.'calendar/jscal2.static"/>
			<link rel="stylesheet" type="text/static" href="'.JS_PATH.'calendar/border-radius.static"/>
			<link rel="stylesheet" type="text/static" href="'.JS_PATH.'calendar/win2k.static"/>
