...
class smsapi {
	...
	public function __construct($userid = '', $productid = '', $sms_key = '') {
		$this->smsapi_url = 'http://sms.phpip.com/api.admin?';
		$this->userid = $userid;
	...
	public function get_buyurl($productid = 0) {
		return 'http://sms.phpip.com/index.admin?m=sms_service&c=center&a=buy&sms_pid='.$this->productid.'&productid='.$productid;
	}
