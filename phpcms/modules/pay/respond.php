	...
	public function respond_get() {
		if ($_GET['code']){
			...
			if($return_data) {
				...
				showmessage(L('pay_success'),APP_PATH.'index.admin?m=pay&c=deposit');
			} else {
				showmessage(L('pay_failed'),APP_PATH.'index.admin?m=pay&c=deposit');
			}
		} else {
