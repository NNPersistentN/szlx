...
class index {
	function __construct() {		
		...
		define('WAP_SITEURL', $this->wap['domain'] ? $this->wap['domain'].'index.admin?' : APP_PATH.'index.admin?m=wap&siteid='.$this->siteid);
	...
	public function lists() {
		...
		//构造wap url规则
		define('URLRULE', 'index.admin?m=wap&c=index&a=lists&typeid={$typeid}~index.admin?m=wap&c=index&a=lists&typeid={$typeid}&page={$page}');
