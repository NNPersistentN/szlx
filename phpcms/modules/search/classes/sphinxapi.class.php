 ...
 */
//
// $Id: sphinxapi.admin 2055 2009-11-06 23:09:58Z shodan $
//
...
function sphUnpackU64 ( $v )
{
	...
	if ( PHP_INT_SIZE>=8 )
	{
		if ( $hi<0 ) $hi += (1<<32); // because admin 5.2.2 to 5.2.5 is totally fucked up again
		if ( $lo<0 ) $lo += (1<<32);
...
function sphFixUint ( $value )
{
	...
	{
		// x32 route, workaround admin signed/unsigned braindamage
