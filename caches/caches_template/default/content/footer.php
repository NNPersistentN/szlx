<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="footer" style="background: none;padding-top:0" >
...
<script src="<?php echo JS_PATH;?>mobile/jquery-3.1.1.min.js"></script>
