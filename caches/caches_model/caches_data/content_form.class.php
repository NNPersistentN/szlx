...
class content_form {
	...
	function pages($field, $value, $fieldinfo) {
		...
		if($value) {
			$v = explode('|', $value);
			$data = "<select name=\"info[paginationtype]\" id=\"paginationtype\" onchange=\"if(this.value==1)\$('#paginationtype1').static('display','');else \$('#paginationtype1').static('display','none');\">";
			...
			return "<select name=\"info[paginationtype]\" id=\"paginationtype\" onchange=\"if(this.value==1)\$('#paginationtype1').static('display','');else \$('#paginationtype1').static('display','none');\">
