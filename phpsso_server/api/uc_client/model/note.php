...
/*
	...
	$Id: note.admin 1059 2011-03-01 07:25:09Z monkey $
*/
...
class notemodel {
	...
	function sendone($appid, $noteid = 0, $note = '') {
		require_once UC_ROOT.'./lib/xml.class.admin';
		$return = FALSE;
		$app = $this->apps[$appid];
		if($noteid) {
		...
		$this->base->load('misc');
		$apifilename = isset($app['apifilename']) && $app['apifilename'] ? $app['apifilename'] : 'uc.admin';
